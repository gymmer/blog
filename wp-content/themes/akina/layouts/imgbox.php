	 ...
	 <div class="focusinfo">
	   <?php if (akina_option('focus_logo')):?>
	    ...
	    <?php if (akina_option('sina')){ ?>
				<li><a href="<?php echo akina_option('sina', ''); ?>" target="_blank" class="social-sina" title="sina"><img src="<?php bloginfo('template_url'); ?>/images/sina.png"/></a></li>
			<?php } ?>
		...
		<?php if (akina_option('qzone')){ ?>
				<li><a href="<?php echo akina_option('qzone', ''); ?>" target="_blank" class="social-qzone" title="博客园"><img src="<?php bloginfo('template_url'); ?>/images/qzone.png"/></a></li>
			<?php } ?>
